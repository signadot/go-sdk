...
// WithAssistantName adds the assistantName to the assistant add message params
func (o *AssistantAddMessageParams) WithAssistantName(assistantName string) *AssistantAddMessageParams {
	o.SetAssistantName(assistantName)
	return o
}

// SetAssistantName adds the assistantName to the assistant add message params
func (o *AssistantAddMessageParams) SetAssistantName(assistantName string) {
