...
func (o *TestExecutionTrafficDiffReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /orgs/{orgName}/tests/{testName}/executions/{executionName}/traffic-diff] test-execution-traffic-diff", response, response.Code())
	}
}
...
type TestExecutionTrafficDiffOK struct {
	Payload *models.TrafficmodelsDiffResult
}
...
func (o *TestExecutionTrafficDiffOK) Error() string {
	...
	return fmt.Sprintf("[GET /orgs/{orgName}/tests/{testName}/executions/{executionName}/traffic-diff][%d] testExecutionTrafficDiffOK %s", 200, payload)
}
...
func (o *TestExecutionTrafficDiffOK) GetPayload() *models.TrafficmodelsDiffResult {
	return o.Payload
}
...
func (o *TestExecutionTrafficDiffOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.TrafficmodelsDiffResult)
...
func (o *TestExecutionTrafficDiffBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/tests/{testName}/executions/{executionName}/traffic-diff][%d] testExecutionTrafficDiffBadRequest %s", 400, payload)
}
...
func (o *TestExecutionTrafficDiffUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/tests/{testName}/executions/{executionName}/traffic-diff][%d] testExecutionTrafficDiffUnauthorized %s", 401, payload)
}
...
func (o *TestExecutionTrafficDiffBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/tests/{testName}/executions/{executionName}/traffic-diff][%d] testExecutionTrafficDiffBadGateway %s", 502, payload)
}
