...
func (o *CancelTestExecutionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /orgs/{orgName}/tests/executions/{executionName}/cancel] cancel-test-execution", response, response.Code())
	}
}
...
func (o *CancelTestExecutionOK) Error() string {
	...
	return fmt.Sprintf("[PUT /orgs/{orgName}/tests/executions/{executionName}/cancel][%d] cancelTestExecutionOK %s", 200, payload)
}
...
func (o *CancelTestExecutionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orgs/{orgName}/tests/executions/{executionName}/cancel][%d] cancelTestExecutionBadRequest %s", 400, payload)
}
...
func (o *CancelTestExecutionUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orgs/{orgName}/tests/executions/{executionName}/cancel][%d] cancelTestExecutionUnauthorized %s", 401, payload)
}
...
func (o *CancelTestExecutionBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orgs/{orgName}/tests/executions/{executionName}/cancel][%d] cancelTestExecutionBadGateway %s", 502, payload)
}
