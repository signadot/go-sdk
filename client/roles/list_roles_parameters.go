...
// WithOrgName adds the orgName to the list roles params
func (o *ListRolesParams) WithOrgName(orgName string) *ListRolesParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the list roles params
func (o *ListRolesParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
