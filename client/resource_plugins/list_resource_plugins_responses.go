...
type ListResourcePluginsOK struct {
	Payload []*models.GithubComSignadotSignadotWorkspacesAppInternalResourcepluginsCluster
}
...
func (o *ListResourcePluginsOK) GetPayload() []*models.GithubComSignadotSignadotWorkspacesAppInternalResourcepluginsCluster {
	return o.Payload
}
