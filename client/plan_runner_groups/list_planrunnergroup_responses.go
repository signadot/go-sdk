...
func (o *ListPlanrunnergroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /orgs/{orgName}/planrunnergroups] list-planrunnergroup", response, response.Code())
	}
}
...
func (o *ListPlanrunnergroupOK) Error() string {
	...
	return fmt.Sprintf("[GET /orgs/{orgName}/planrunnergroups][%d] listPlanrunnergroupOK %s", 200, payload)
}
...
func (o *ListPlanrunnergroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/planrunnergroups][%d] listPlanrunnergroupBadRequest %s", 400, payload)
}
...
func (o *ListPlanrunnergroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/planrunnergroups][%d] listPlanrunnergroupUnauthorized %s", 401, payload)
}
...
func (o *ListPlanrunnergroupBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/planrunnergroups][%d] listPlanrunnergroupBadGateway %s", 502, payload)
}
