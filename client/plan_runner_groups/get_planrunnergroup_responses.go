...
func (o *GetPlanrunnergroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /orgs/{orgName}/plan-runnergroups/{planRunnerGroupName}] get-planrunnergroup", response, response.Code())
	}
}
...
func (o *GetPlanrunnergroupOK) Error() string {
	...
	return fmt.Sprintf("[GET /orgs/{orgName}/plan-runnergroups/{planRunnerGroupName}][%d] getPlanrunnergroupOK %s", 200, payload)
}
...
func (o *GetPlanrunnergroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/plan-runnergroups/{planRunnerGroupName}][%d] getPlanrunnergroupBadRequest %s", 400, payload)
}
...
func (o *GetPlanrunnergroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/plan-runnergroups/{planRunnerGroupName}][%d] getPlanrunnergroupUnauthorized %s", 401, payload)
}
...
func (o *GetPlanrunnergroupBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/plan-runnergroups/{planRunnerGroupName}][%d] getPlanrunnergroupBadGateway %s", 502, payload)
}
