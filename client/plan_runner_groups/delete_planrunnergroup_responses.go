...
func (o *DeletePlanrunnergroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}] delete-planrunnergroup", response, response.Code())
	}
}
...
func (o *DeletePlanrunnergroupOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] deletePlanrunnergroupOK %s", 200, payload)
}
...
func (o *DeletePlanrunnergroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] deletePlanrunnergroupBadRequest %s", 400, payload)
}
...
func (o *DeletePlanrunnergroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] deletePlanrunnergroupUnauthorized %s", 401, payload)
}
...
func (o *DeletePlanrunnergroupBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] deletePlanrunnergroupBadGateway %s", 502, payload)
}
