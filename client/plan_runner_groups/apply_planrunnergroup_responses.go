...
func (o *ApplyPlanrunnergroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}] apply-planrunnergroup", response, response.Code())
	}
}
...
func (o *ApplyPlanrunnergroupOK) Error() string {
	...
	return fmt.Sprintf("[PUT /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] applyPlanrunnergroupOK %s", 200, payload)
}
...
func (o *ApplyPlanrunnergroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] applyPlanrunnergroupBadRequest %s", 400, payload)
}
...
func (o *ApplyPlanrunnergroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] applyPlanrunnergroupUnauthorized %s", 401, payload)
}
...
func (o *ApplyPlanrunnergroupBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orgs/{orgName}/planrunnergroups/{planRunnerGroupName}][%d] applyPlanrunnergroupBadGateway %s", 502, payload)
}
