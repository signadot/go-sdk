...
type ApplyRoutegroupParams struct {
	...
	*/
	Data *models.RoutegroupsRouteGroup
...
func (o *ApplyRoutegroupParams) WithData(data *models.RoutegroupsRouteGroup) *ApplyRoutegroupParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the apply routegroup params
func (o *ApplyRoutegroupParams) SetData(data *models.RoutegroupsRouteGroup) {
	o.Data = data
}
