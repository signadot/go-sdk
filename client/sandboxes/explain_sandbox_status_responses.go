...
func (o *ExplainSandboxStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 502:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain] explain-sandbox-status", response, response.Code())
	}
}
...
func (o *ExplainSandboxStatusOK) Error() string {
	...
	return fmt.Sprintf("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain][%d] explainSandboxStatusOK %s", 200, payload)
}
...
func (o *ExplainSandboxStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.SandboxesSandboxStatusExplainResponse)
...
func (o *ExplainSandboxStatusBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain][%d] explainSandboxStatusBadRequest %s", 400, payload)
}
...
func (o *ExplainSandboxStatusUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain][%d] explainSandboxStatusUnauthorized %s", 401, payload)
}
...
func (o *ExplainSandboxStatusNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain][%d] explainSandboxStatusNotFound %s", 404, payload)
}
...
func (o *ExplainSandboxStatusNotImplemented) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain][%d] explainSandboxStatusNotImplemented %s", 501, payload)
}
...
func (o *ExplainSandboxStatusBadGateway) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/sandboxes/{sandboxName}/status/explain][%d] explainSandboxStatusBadGateway %s", 502, payload)
}
