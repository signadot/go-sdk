...
// WithClusterName adds the clusterName to the delete cluster params
func (o *DeleteClusterParams) WithClusterName(clusterName string) *DeleteClusterParams {
	o.SetClusterName(clusterName)
	return o
}

// SetClusterName adds the clusterName to the delete cluster params
func (o *DeleteClusterParams) SetClusterName(clusterName string) {
	o.ClusterName = clusterName
}

// WithOrgName adds the orgName to the delete cluster params
func (o *DeleteClusterParams) WithOrgName(orgName string) *DeleteClusterParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the delete cluster params
func (o *DeleteClusterParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
