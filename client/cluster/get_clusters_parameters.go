...
// WithOrgName adds the orgName to the get clusters params
func (o *GetClustersParams) WithOrgName(orgName string) *GetClustersParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the get clusters params
func (o *GetClustersParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
