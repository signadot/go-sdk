...
type ListPlanExecutionsOK struct {
	Payload []*models.PlanExecutionQueryResult
}
...
func (o *ListPlanExecutionsOK) GetPayload() []*models.PlanExecutionQueryResult {
	return o.Payload
}
...
// Code gets the status code for the list plan executions bad request response
func (o *ListPlanExecutionsBadRequest) Code() int {
	return 400
}

func (o *ListPlanExecutionsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/plans/executions][%d] listPlanExecutionsBadRequest %s", 400, payload)
}
