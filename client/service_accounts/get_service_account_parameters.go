...
// WithOrgName adds the orgName to the get service account params
func (o *GetServiceAccountParams) WithOrgName(orgName string) *GetServiceAccountParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the get service account params
func (o *GetServiceAccountParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
