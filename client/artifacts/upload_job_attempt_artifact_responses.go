...
func (o *UploadJobAttemptArtifactOK) Error() string {
	return fmt.Sprintf("[POST /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/upload][%d] uploadJobAttemptArtifactOK  %+v", 200, o.Payload)
}
...
func (o *UploadJobAttemptArtifactBadRequest) Error() string {
	return fmt.Sprintf("[POST /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/upload][%d] uploadJobAttemptArtifactBadRequest  %+v", 400, o.Payload)
}
...
func (o *UploadJobAttemptArtifactUnauthorized) Error() string {
	return fmt.Sprintf("[POST /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/upload][%d] uploadJobAttemptArtifactUnauthorized  %+v", 401, o.Payload)
}
...
func (o *UploadJobAttemptArtifactRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[POST /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/upload][%d] uploadJobAttemptArtifactRequestEntityTooLarge  %+v", 413, o.Payload)
}
...
func (o *UploadJobAttemptArtifactInternalServerError) Error() string {
	return fmt.Sprintf("[POST /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/upload][%d] uploadJobAttemptArtifactInternalServerError  %+v", 500, o.Payload)
}
