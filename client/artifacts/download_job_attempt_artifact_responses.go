...
func (o *DownloadJobAttemptArtifactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 401:
		...
		return nil, result
	case 404:
		result := NewDownloadJobAttemptArtifactNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DownloadJobAttemptArtifactOK) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/download][%d] downloadJobAttemptArtifactOK", 200)
}
...
func (o *DownloadJobAttemptArtifactPartialContent) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/download][%d] downloadJobAttemptArtifactPartialContent", 206)
}
...
func (o *DownloadJobAttemptArtifactBadRequest) Error() string {
	...
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/download][%d] downloadJobAttemptArtifactBadRequest %s", 400, payload)
}
...
func (o *DownloadJobAttemptArtifactUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/download][%d] downloadJobAttemptArtifactUnauthorized %s", 401, payload)
}
...
func NewDownloadJobAttemptArtifactNotFound() *DownloadJobAttemptArtifactNotFound {
	return &DownloadJobAttemptArtifactNotFound{}
}
...
func (o *DownloadJobAttemptArtifactNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/download][%d] downloadJobAttemptArtifactNotFound %s", 404, payload)
}
...
func (o *DownloadJobAttemptArtifactNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DownloadJobAttemptArtifactInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/download][%d] downloadJobAttemptArtifactInternalServerError %s", 500, payload)
}
