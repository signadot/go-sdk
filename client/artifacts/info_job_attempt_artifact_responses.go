...
func (o *InfoJobAttemptArtifactOK) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/][%d] infoJobAttemptArtifactOK  %+v", 200, o.Payload)
}
...
func (o *InfoJobAttemptArtifactBadRequest) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/][%d] infoJobAttemptArtifactBadRequest  %+v", 400, o.Payload)
}
...
func (o *InfoJobAttemptArtifactUnauthorized) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/][%d] infoJobAttemptArtifactUnauthorized  %+v", 401, o.Payload)
}
...
func (o *InfoJobAttemptArtifactNotFound) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/][%d] infoJobAttemptArtifactNotFound  %+v", 404, o.Payload)
}
...
func (o *InfoJobAttemptArtifactInternalServerError) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}/objects/][%d] infoJobAttemptArtifactInternalServerError  %+v", 500, o.Payload)
}
