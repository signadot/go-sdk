...
func (o *ListJobAttemptArtifactsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
...
func (o *ListJobAttemptArtifactsOK) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}][%d] listJobAttemptArtifactsOK  %+v", 200, o.Payload)
}
...
func (o *ListJobAttemptArtifactsBadRequest) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}][%d] listJobAttemptArtifactsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListJobAttemptArtifactsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}][%d] listJobAttemptArtifactsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListJobAttemptArtifactsNotFound) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}][%d] listJobAttemptArtifactsNotFound  %+v", 404, o.Payload)
}
...
func (o *ListJobAttemptArtifactsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/artifacts/jobs/{jobName}/attempts/{jobAttempt}][%d] listJobAttemptArtifactsInternalServerError  %+v", 500, o.Payload)
}
