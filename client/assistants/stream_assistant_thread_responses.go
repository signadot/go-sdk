...
func (o *StreamAssistantThreadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /orgs/{orgName}/assistants/{assistantName}/threads/{threadID}/] stream-assistant-thread", response, response.Code())
	}
}
...
func (o *StreamAssistantThreadOK) Error() string {
	return fmt.Sprintf("[GET /orgs/{orgName}/assistants/{assistantName}/threads/{threadID}/][%d] streamAssistantThreadOK", 200)
}
...
func (o *StreamAssistantThreadBadRequest) Error() string {
	...
	return fmt.Sprintf("[GET /orgs/{orgName}/assistants/{assistantName}/threads/{threadID}/][%d] streamAssistantThreadBadRequest %s", 400, payload)
}
...
func (o *StreamAssistantThreadUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/assistants/{assistantName}/threads/{threadID}/][%d] streamAssistantThreadUnauthorized %s", 401, payload)
}
...
func (o *StreamAssistantThreadNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orgs/{orgName}/assistants/{assistantName}/threads/{threadID}/][%d] streamAssistantThreadNotFound %s", 404, payload)
}
