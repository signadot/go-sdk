...
// WithAssistantName adds the assistantName to the stream assistant thread params
func (o *StreamAssistantThreadParams) WithAssistantName(assistantName string) *StreamAssistantThreadParams {
	o.SetAssistantName(assistantName)
	return o
}

// SetAssistantName adds the assistantName to the stream assistant thread params
func (o *StreamAssistantThreadParams) SetAssistantName(assistantName string) {
