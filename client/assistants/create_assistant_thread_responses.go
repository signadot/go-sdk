...
func (o *CreateAssistantThreadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 401:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /orgs/{orgName}/assistants/threads/] create-assistant-thread", response, response.Code())
	}
}
...
func (o *CreateAssistantThreadOK) Error() string {
	...
	return fmt.Sprintf("[POST /orgs/{orgName}/assistants/threads/][%d] createAssistantThreadOK %s", 200, payload)
}
...
func (o *CreateAssistantThreadBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /orgs/{orgName}/assistants/threads/][%d] createAssistantThreadBadRequest %s", 400, payload)
}
...
func (o *CreateAssistantThreadUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /orgs/{orgName}/assistants/threads/][%d] createAssistantThreadUnauthorized %s", 401, payload)
}
