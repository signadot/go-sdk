...
func (m *ResourcepluginStep) validateEnv(formats strfmt.Registry) error {
...
func (m *ResourcepluginStep) contextValidateEnv(ctx context.Context, formats strfmt.Registry) error {
