...
func (m *V1PodTemplateSpec) validateManagedFields(formats strfmt.Registry) error {
...
func (m *V1PodTemplateSpec) validateOwnerReferences(formats strfmt.Registry) error {
...
func (m *V1PodTemplateSpec) contextValidateManagedFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1PodTemplateSpec) contextValidateOwnerReferences(ctx context.Context, formats strfmt.Registry) error {
