...
func (m *SandboxSandbox) validateMeta(formats strfmt.Registry) error {
...
func (m *SandboxSandbox) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
