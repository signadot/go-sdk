...
// PlansStepAction plans step action
//
// swagger:model plans.StepAction
type PlansStepAction struct {
	...
	Outputs []*PlansField `json:"outputs"`
...
// Validate validates this plans step action
func (m *PlansStepAction) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PlansStepAction) validateOutputs(formats strfmt.Registry) error {
...
func (m *PlansStepAction) validateParams(formats strfmt.Registry) error {
...
// ContextValidate validate this plans step action based on the context it is used
func (m *PlansStepAction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PlansStepAction) contextValidateOutputs(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PlansStepAction) contextValidateParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PlansStepAction) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PlansStepAction) UnmarshalBinary(b []byte) error {
	var res PlansStepAction
