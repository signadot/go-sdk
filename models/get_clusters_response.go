...
func (m *GetClustersResponse) validateClusters(formats strfmt.Registry) error {
...
// ContextValidate validate this get clusters response based on the context it is used
func (m *GetClustersResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetClustersResponse) contextValidateClusters(ctx context.Context, formats strfmt.Registry) error {
