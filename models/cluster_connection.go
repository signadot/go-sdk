...
//
// swagger:model cluster.Connection
...
func (m *ClusterConnection) validateStatus(formats strfmt.Registry) error {
...
func (m *ClusterConnection) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
